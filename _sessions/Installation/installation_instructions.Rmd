...
author: "<table style='table-layout:fixed;width:100%;border:0;padding:0;margin:0'><col width='10%'><col width='10%'>
  <tr style='border:none'>
    <td style='display:block;width:100%;text-align:left;vertical-align:bottom;padding:0;margin:0;border:none' nowrap>
      <font style='font-style:normal'>Reporting mit R - Februar 2021</font><br>
...
Diese Schritt für Schritt Anleitung hilft dir dabei, alles für den Kurs *Reporting mit R* aufzusetzen. Für den Kurs werden wir die Programme *R* und *RStudio*, sowie einige zusätzliche *R Pakete* benötigen.
...
```{r eval = FALSE, echo = TRUE}
source('https://tinyurl.com/yc7vngfo')
```

Wenn Du gefragt wirst, ob du Pakete *from source* installieren möchtest, gebe *n* ein und drücke *Enter*. So hast Du zwar manchmal nicht die allerneueste Version, aber für den Kurs spielt das keine Rolle und es gibt deutlich weniger Installationsprobleme.
