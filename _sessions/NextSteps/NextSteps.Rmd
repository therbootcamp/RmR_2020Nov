 ...
 <table width=50% cellspacing=0 cellpadding=0 class="courses">
        ...
        <tr>
          <td align=center>
            ...
            <h4><span style="font-size:12px">Webinar</span><br>Einführung in die moderne<br>Datenanalyse mit R</h4>
              <img class="course-img" src="https://therbootcamp.github.io/img/courses/0.png">
            </a>
          </td>
          <td align=center>
            <a href="https://advancedstudies.unibas.ch/studienangebot/kurs/explorative-datenanalyse-mit-r-272006">
