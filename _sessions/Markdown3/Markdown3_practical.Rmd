...
8. Als letztes Gestaltungselement ergänze `theme: lumen` auf der selben Ebene wie `toc: true` oberhalb von `includes:`, womit verschiedene Eigenschaften des Schriftbildes angepasst werden (<a href = 'https://www.datadreaming.org/post/r-markdown-theme-gallery/'>hier</a> findest du einen Übersicht über weitere Themes)
